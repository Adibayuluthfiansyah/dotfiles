-- omarchy_animations.lua ← animations/omarchy_animations.conf (active block only)
...
hl.animation({ leaf = "windows", enabled = true, speed = 5, bezier = "easeOutQuint", style = "popin 90%" })
hl.animation({ leaf = "windowsIn", enabled = true, speed = 5, bezier = "easeOutQuint", style = "popin 90%" })
